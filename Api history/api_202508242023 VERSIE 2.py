      ...
      <div class="filters">
        ...
        <div id="moreFilters">
          <div class="group">
           ...
           <div class="hint">Komt de vochttoestand op de locatie niet overeen met de kaart? Selecteer hier een waarde om de kaartwaarde te overschrijven.</div>
...
function computeUsage(){
  ...
  // Gebruik kaartcontext wanneer UI leeg is
  ...
  // Bewaar context voor vervolgacties (UI-wijzigingen/refresh)
  ui.ctx = { vocht: j.vocht || null, bodem: j.bodem || null };

  // Eén centrale refresh die de context meeneemt
  refresh();
});
