  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .pw-locate-btn {
      ...
      border:1px solid #1f2c49; background:#0c1730; color:#e6edf3;
    ...
    /* Uitklapbalk */
    .more-toggle {
      width:100%; margin:10px 0 0; background:#0c1730; border:1px solid #1f2c49;
      padding:6px 10px; border-radius:8px; display:flex; align-items:center; justify-content:space-between;
    ...
    <div class="panel panel-right">
      <div class="filters">
        ...
        <div id="moreBar" class="more-toggle" title="Meer filters tonen/verbergen">
          <strong>Meer filters en opties</strong>
  ...
  <script>
    ...
    const LocateCtl = L.Control.extend({
      ...
      onAdd: function() {
        ...
        btn.type = 'button'; btn.title = 'Mijn locatie';
        btn.textContent = '📍';
    ...
    async function loadWms(){
      ...
      // Lagen-schakelaar: alleen overlays, linksonder + titel
    ...
    async function fetchList(){
      ...
      url.searchParams.set('limit','1000'); // server haalt toch alles op; hoge cap
    ...
    // Klik op de kaart → context en lijst
    map.on('click', async (e)=>{
      ...
      // Lijst met UI-filters + (indien leeg) kaartwaarden
